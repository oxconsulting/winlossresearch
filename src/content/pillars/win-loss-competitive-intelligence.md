---
title: "Win/Loss Research for Competitive Intelligence"
description: "Rep debriefs and CRM tagging structurally miss the real competitive story. Independent buyer interviews recover what actually drove the loss."
...
A [feature gap](/glossary/feature-gap/) is a real, missing capability, and the fix belongs on the product roadmap. A [perception gap](/glossary/perception-gap/) is a capability that already exists, and the fix belongs with sales enablement and product marketing, because building something that already shipped solves nothing. CRM data logs both the same way, as a lost feature comparison against a named competitor, which is exactly why the two get confused at scale.
...
### FAQ
- [How does win/loss research improve competitive intelligence?](/faq/how-does-win-loss-research-improve-competitive-intelligence/)
