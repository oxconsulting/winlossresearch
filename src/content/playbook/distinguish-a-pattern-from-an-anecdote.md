---
title: "How to Distinguish a Pattern from an Anecdote in Win/Loss Data"
description: "A finding becomes a pattern at three to five independent mentions, weighted toward what recurs across losses over wins."
phase: "analyze"
phaseOrder: 2
...
1. [What counts as a pattern](#what-counts-as-a-pattern)
2. [Why the threshold sits at three to five](#why-the-threshold-sits-at-three-to-five)
3. [Weighting losses over wins when judging a pattern](#weighting-losses-over-wins-when-judging-a-pattern)
4. [A worked example, from passing comment to finding](#a-worked-example-from-passing-comment-to-finding)
5. [Guard against analyst bias on borderline calls](#guard-against-analyst-bias-on-borderline-calls)
