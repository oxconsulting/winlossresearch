---
title: "How to Measure Whether a Win/Loss Program Is Working"
description: "Track how many specific decisions a program's findings actually changed, not interview counts or report cadence."
phase: "sustain"
phaseOrder: 2
...
1. [The activity trap: why interview counts aren't a success metric](#the-activity-trap-why-interview-counts-arent-a-success-metric)
2. [What to track instead: decisions changed, not reports delivered](#what-to-track-instead-decisions-changed-not-reports-delivered)
3. [A simple scorecard template](#a-simple-scorecard-template)
4. [Reviewing the scorecard at each cycle](#reviewing-the-scorecard-at-each-cycle)
5. [When an empty scorecard is the real finding](#when-an-empty-scorecard-is-the-real-finding)
...
An internal team stretched across other responsibilities can fall into this trap without anyone noticing it happening. Getting a full interview set scheduled in a quarter, given everyone's competing workload, genuinely feels like an accomplishment, and that feeling quietly substitutes for the harder question of whether any of those interviews led to a decision getting made differently.
