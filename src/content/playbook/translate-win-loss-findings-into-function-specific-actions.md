---
title: "How to Translate Win/Loss Findings into Function-Specific Actions"
description: "A finding-type-to-function matrix maps each finding to the specific action Product, PMM, Sales, and CI should take."
phase: "report-distribute"
phaseOrder: 2
relatedPillars: ["win-loss-gtm-strategy", "how-to-build-win-loss-program"]
draft: false
---
...
1. [Build the finding-type-to-function matrix](#step-1-build-the-finding-type-to-function-matrix)
2. [Translate a competitive finding across functions](#step-2-translate-a-competitive-finding-across-functions)
3. [Translate a messaging finding across functions](#step-3-translate-a-messaging-finding-across-functions)
4. [Translate a process friction finding across functions](#step-4-translate-a-process-friction-finding-across-functions)
5. [Assign an owner and deadline to every action](#step-5-assign-an-owner-and-deadline-to-every-action)
...
<pre>Finding Type            | Product        | Product Marketing  | Sales               | Competitive Intel
-------------------------|----------------|---------------------|---------------------|-------------------
...
Onboarding/Product Gap    | Roadmap item  | -                   | -                   | -</pre>
</div>
...
<div class="example-block">
<span class="example-label">Example</span>
<pre>Product:                Evaluate implementation speed as a
...
<div class="example-block">
<span class="example-label">Example</span>
<pre>Product Marketing:       Revise the message, or build a leave-
...
<div class="example-block">
<span class="example-label">Example</span>
<pre>Finding: Competitor winning on implementation speed
Action: Update battlecard entry
Function: Competitive Intelligence
Owner: [Name]
Deadline: [Date, typically within 2 weeks of the readout]</pre>
</div>

Track these owner-and-deadline rows against the follow-up check described in [how to deliver a win/loss readout](/playbook/deliver-a-win-loss-readout/), so the two-to-three-week follow-up has a specific list to check status against rather than a general question of whether the readout "led anywhere."
...
### Next Phase
- [How to Set and Adjust Your Win/Loss Program Cadence](/playbook/set-a-win-loss-program-cadence/)
