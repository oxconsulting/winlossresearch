...
const STANDARD_FIELDS = [
  ...
  { key: "close_date",            label: "Close Date",            description: "Date deal was closed won or lost", required: true  },
  { key: "outcome",               label: "Deal Outcome",          description: "Win or Loss",                      required: true  },
  { key: "close_reason",          label: "Closed Reason",         description: "Rep-entered close/loss reason",    required: true  },
  { key: "deal_value",            label: "Deal Value",            description: "ACV or deal size",                 required: true  },
  { key: "rep_name",              label: "Rep Name",              description: "Owning sales rep",                 required: false },
  { key: "primary_competitor",    label: "Primary Competitor",    description: "Competitor credited in CRM",       required: true  },
  { key: "vertical",              label: "Industry/Vertical",     description: "Industry or vertical",             required: false },
  { key: "geo",                   label: "Geo",                   description: "Geography or region",              required: true  },
  ...
  { key: "primary_contact_email", label: "Primary Contact Email", description: "Main buyer contact email",         required: true  },
  { key: "company_name",          label: "Company Name",          description: "Prospect/customer company",        required: true  },
